        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
            <form method="POST" action="{{ route('courses.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" class="w-full mt-1 p-2 border rounded dark:bg-gray-700 dark:text-white">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" rows="4" class="w-full mt-1 p-2 border rounded dark:bg-gray-700 dark:text-white">{{ old('description') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="price" value="{{ old('price') }}" class="w-full mt-1 p-2 border rounded dark:bg-gray-700 dark:text-white">
